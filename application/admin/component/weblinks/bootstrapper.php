...
class WeblinksBootstrapper extends Library\BootstrapperAbstract
{
    public function bootstrap()
    {
        ...
        $manager->registerAlias('com:weblinks.view.attachment.file', 'com:attachments.view.attachment.file');
        $manager->registerAlias('com:weblinks.controller.attachment', 'com:articles.controller.attachment');
    }
}