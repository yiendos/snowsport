...
class SignaturesBootstrapper extends Library\BootstrapperAbstract
{
    public function bootstrap()
    {
        ...
        $manager->registerAlias('com:signatures.view.attachment.file', 'com:attachments.view.attachment.file');
        $manager->registerAlias('com:signatures.controller.attachment', 'com:articles.controller.attachment');
    }
}